...
import com.parkandride.park_and_ride_mvp.security.JwtFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/ride/book").permitAll()
                        //.requestMatchers("/api/pricing/**").permitAll() // ✅ Added pricing endpoint
                        .requestMatchers(HttpMethod.GET, "/api/pricing/**").permitAll()

                        .requestMatchers("/parking-updates/**").permitAll()
                        .requestMatchers("/lpr/recognize").permitAll()
...
public class SecurityConfig {
    ...
    // Commenting JWT filter out for now
    // private final JwtFilter jwtFilter;
